...
export default function Home() {
  ...
  async function saveLink() {
    ...
    if (checkLinkExists(formattedUrl)) {
      toast.error('Bro! You already have this link saved');
      return
    }
      ...
      <div class="container mx-auto px-4 flex justify-center mt-10">
        <div class="relative lg:w-1/2 w-full">
          ...
          <div class="flex justify-center gap-5 mt-5">
            <a href="javascript:void(0);" onClick={() => exportBookmarks()} class="py-1 px-2 inline-flex justify-center items-center gap-1 rounded-md border border-transparent font-semibold bg-yellow-500 dark:bg-yellow-900 text-white hover:bg-yellow-600 dark:hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 transition-all text-xs dark:focus:ring-offset-gray-800">
