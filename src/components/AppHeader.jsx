...
export function AppHeader() {
    ...
    return (
        <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
            <nav class="shadow-sm shadow-grey-100 dark:shadow-gray-600 mt-6 relative max-w-7xl w-full bg-gradient-to-r from-yellow-300 to-yellow-100 border dark:bg-gradient-to-r dark:from-yellow-900 dark:to-yellow-300 border-gray-200 dark:border-gray-600 rounded-[25px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700" aria-label="Global">
                <div class="flex-none">
                    <div class="flex flex-wrap items-center justify-between">
                        <div class="flex items-center gap-5">
                            ...
                            <div class="hs-dropdown" data-hs-dropdown-placement="bottom-right" data-hs-dropdown-offset="30">
                                <a class="hs-dropdown-toggle hs-dark-mode group flex items-center text-gray-700 hover:text-yellow-700 font-medium dark:text-gray-400 dark:hover:text-gray-500" href="javascript:;">
                        ...
                        <div class="md:hidden">
                            <button type="button" class="hs-collapse-toggle p-2 inline-flex justify-center items-center gap-2 rounded-full border font-medium bg-white text-gray-700 shadow-sm align-middle hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-blue-600 transition-all text-sm dark:bg-yellow-900 dark:hover:bg-yellow-800 dark:border-gray-700 dark:text-gray-400 dark:hover:text-white dark:focus:ring-offset-gray-800" data-hs-collapse="#navbar-collapse-with-animation" aria-controls="navbar-collapse-with-animation" aria-label="Toggle navigation">
                ...
                <div id="navbar-collapse-with-animation" class="hs-collapse hidden overflow-hidden transition-all duration-300 basis-full grow md:block">
                    <div class="flex flex-col gap-y-4 gap-x-0 mt-5 md:flex-row md:items-center md:justify-end md:gap-y-0 md:gap-x-7 md:mt-0 md:pl-7">
                        <Link href="https://github.com/Lokeshsri11" className={`font-medium text-black-800 md:py-6 dark:text-black-100 dark:md:text-gray-900`} aria-current="page">Loki</Link>
                    </div>
                </div>
            </nav>
        </header>
